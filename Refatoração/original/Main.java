...
public class Main {
    // criar o tabuleiro 3x3 com alocação dinâmica (essa função retorna uma matriz
    // bidimensional)
    ...
    public static void main(String[] args) {
        ...
        while (!fimDoJogo) {
            ...
            // verificar se a linha e a coluna informadas são válidas e conferir se o local
            // escolhido está disponível
        ...
        scanner.close();
        // não é necessário liberar a memória em Java, o coletor de lixo faz isso
        // automaticamente.
    }
}